...
class Test_slugify_in_context(unittest.TestCase):
    def _callFUT(self, context, name, remove_extension=True):
        from substanced.folder.views import slugify_in_context
    ...
    def test_uniquness_without_extension(self):
        ...
        self.assertEqual(self._callFUT(context, 'boo.txt'), 'boo-3')
...
class Test_multi_upload_submit(unittest.TestCase):
    ...
    def test_upload_multiple(self):
        ...
        # Make sure we get the exact order we specify
        params = Dummy(values=lambda: [
            dummyFileParam1,
            dummyFileParam2,
            dummyFileParam3,
            ])
